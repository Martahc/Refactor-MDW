...
public class CustomerTest {
	...
	public void withoutRentalsTest() {
		...
		String result = new StatementBuilder().customerName(customerName).frequentRenterPoints(0).build();
	...
	public void regularRental1DayTest() {
		...
		String result = new StatementBuilder().customerName(customerName).movie(movieName, 2).frequentRenterPoints(1).build();
		assertEquals(result, statement);
	}
	...
	public void regularRental3DayTest() {
		...
		String result = new StatementBuilder().customerName(customerName).movie(movieName, 3.5).frequentRenterPoints(1).build();
		assertEquals(result, statement);
	}
	...
	public void newReleaseRental1DayTest() {
		...
		String result = new StatementBuilder().customerName(customerName).movie(movieName, 3).frequentRenterPoints(1).build();
		assertEquals(result, statement);
	}
	...
	public void newReleaseRental2DayTest() {
		...
		String result = new StatementBuilder().customerName(customerName).movie(movieName, 3).frequentRenterPoints(2).build();
		assertEquals(result, statement);
	}
	...
	public void childrensRental1DayTest() {
		...
		String result = new StatementBuilder().customerName(customerName).movie(movieName, 1.5).frequentRenterPoints(1).build();
		assertEquals(result, statement);
	}
	...
	public void childrensRental4DayTest() {
		...
		String result = new StatementBuilder().customerName(customerName).movie(movieName, 6).frequentRenterPoints(1).build();
		assertEquals(result, statement);
	}
	...
	public void rentalTest() {
		...
		String result = new StatementBuilder().customerName(customerName)
				.movie(regularMovieName, 14).movie(newReleaseMovieName, 3).movie(childrensMovieName, 15).frequentRenterPoints(4).build();
		assertEquals(result, statement);
	}
